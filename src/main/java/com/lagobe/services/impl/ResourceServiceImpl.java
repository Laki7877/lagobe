...
import com.lagobe.daos.ResourceDao;
...
import com.lagobe.type.ResourceType;
import com.lagobe.utils.ImageUtil;
import com.lagobe.utils.S3Util;
...
public class ResourceServiceImpl implements ResourceService {
	...
	public Resource upload(MultipartFile multipartFile) throws Exception {
		...
		try {
			...
			file = ImageUtil.compressImage(newBufferedImage, desPath, 0.7f);
